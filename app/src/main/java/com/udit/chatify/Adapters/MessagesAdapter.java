...
import com.udit.chatify.databinding.ItemReceiveBinding;
import com.udit.chatify.databinding.ItemSendBinding;
...
public class MessagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MessagesAdapter(Context context, ArrayList<Message> messages, String senderRoom, String receiverRoom, MessageAdapterListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM_HEADER) {
            ...
            View sentView = inflater.inflate(R.layout.item_send, parent, false);
            return new SentViewHolder(sentView);
        }
        else{
            // Inflate received message layout
            View receivedView = inflater.inflate(R.layout.item_receive, parent, false);
...
//                String fileName = String.valueOf(currentCalendar.getTimeInMillis());
//                viewHolder.binding.downloadBtn.setVisibility(View.VISIBLE);
//                viewHolder.binding.downloadBtn.setOnClickListener(v -> downloadFile(context, message.getImageUrl(),fileName));
            }
